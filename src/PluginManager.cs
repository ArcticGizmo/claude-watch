...
/// <summary>
/// Drives the Claude Code CLI to add the claude-watch marketplace and install/update the
/// <c>claude-watch</c> plugin, and reports its status. The plugin feeds each session's live
