...
/// <summary>
/// Controls how session cat forms are rendered. Extend by creating a new subclass
/// or constructing a new SpriteCatStyle with different images.
/// </summary>
internal abstract class CatStyle
{
    public abstract string Name { get; }

    /// <summary>False means no cat forms are shown at all for this style.</summary>
    ...
    public static readonly CatStyle None    = new NoneCatStyle();
    public static readonly CatStyle Squares = new SquaresCatStyle();
    public static readonly CatStyle Ducks   = new SpriteCatStyle("Ducks",
        LoadSprite("duck-sleep.png"),
        LoadSprite("duck-working.png"),
        LoadSprite("duck-alert.png"));

    public static IReadOnlyList<CatStyle> All { get; } = [None, Squares, Ducks];

    public static CatStyle FromName(string name) =>
...
internal sealed class NoneCatStyle : CatStyle
{
...
internal sealed class SquaresCatStyle : CatStyle
{
...
/// and add it to CatStyle.All (or manage it externally).
/// </summary>
internal sealed class SpriteCatStyle : CatStyle
{
    private readonly Bitmap _idle, _active, _attention;

    public SpriteCatStyle(string name, Bitmap idle, Bitmap active, Bitmap attention)
    {
        Name       = name;
        _idle      = idle;
        _active    = active;
