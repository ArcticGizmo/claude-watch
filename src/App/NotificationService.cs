...
/// <summary>
/// Owns Claude Watch's notification dispatch: the Windows tray balloon plus optional chime for a
...
internal sealed class NotificationService
{
    ...
    public async Task SendExternalTestAsync()
    {
        ...
        if (string.IsNullOrWhiteSpace(host) || string.IsNullOrWhiteSpace(topic))
        {
            ShowInfo("Claude Watch — ntfy", "Enter a server URL and topic first.", ToolTipIcon.Warning);
            return;
        }
